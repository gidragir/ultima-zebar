...
export default function Systray({ systray }: SystrayProps) {
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: handles shift+click expansion
		// biome-ignore lint/a11y/useKeyWithClickEvents: handles shift+click expansion
