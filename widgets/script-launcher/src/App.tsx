...
import type { LauncherCommand } from "@ultima-zebar/config/src/types";
import { generateId } from "@ultima-zebar/config/src/utils/generateId";
import { logger } from "@ultima-zebar/config/src/utils/logger";
import { UpdateScriptModal } from "@ultima-zebar/config-widget";
import {
	Button,
	ContextMenu,
	ContextMenuContent,
