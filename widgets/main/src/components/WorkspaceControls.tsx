...
import { chipStyles } from "@ultima-zebar/ui";
	...
	return (
		<AnimatePresence>
			<motion.div
				...
				className={cn(
					chipStyles,
					"flex items-center gap-1 p-1 h-full rounded-2xl select-none overflow-hidden",
				)}
			>
						...
						>
							{isActive && (
								<motion.span
									...
									style={{ borderRadius: "calc(var(--radius-2xl) - 0.25rem)" }}
								/>
							)}
							<motion.span
								initial={{ opacity: 0 }}
