import { useConfigDispatch, useWidgetSetting } from "@ultima-zebar/config";
import { buttonVariants } from "@ultima-zebar/ui";
...
export default function TitleBar() {
	...
	return (
		<div className="bg-background-deeper border-b border-border flex items-center justify-between w-full rounded-t-lg">
			<h1 className="pl-4 py-2 font-medium">ultima-zebar</h1>
			<button
				type="button"
				onClick={onClose}
				className={cn(
