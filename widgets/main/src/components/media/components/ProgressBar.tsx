...
export function ProgressBar({
	...
	return (
		<div
			className="absolute h-[1.5px] bg-primary bottom-0 left-0 transition-transform duration-200 ease-out origin-left"
			style={{
				width: "100%",
				transform: `scaleX(${
					currentSession ? (progress / currentSession?.endTime) || 0 : 0
				})`,
			}}
		></div>
	);
